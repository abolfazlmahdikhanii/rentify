    ...
    <div className={styles.detailInfo__Title}>
        ...
        <div className={styles.detailShare__btn}>
          ...
          {user?.role !== "admin" && (
            <button className="btn">
              <Heart
                size={22}
                fill={data?.is_favorite ? "#f00" : "#fff"}
                stroke={data?.is_favorite ? "#f00" : "#000"}
              />
            </button>
          )}
        </div>
      ...
      <div className={styles.detailDate}>
        ...
        <p className={styles.detailDate__sub}>
          ...
          {data && data.createdAt && getDateRelative(data?.createdAt)}
        </p>
      </div>
      <div className={styles.detailPrice}>
        {data?.listingType === "mortgage" && (
          <>
            <p className={styles.detailPrice__text}>
              رهن
              <span>
                {data?.mortgagePrice.toLocaleString()}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="25"
                  height="13"
      ...
      <div className={styles.detailReport}>
        <p className={styles.detailReport__text}>
          شناسه آگهی: RNT-{data?._id?.slice(0,6)}
        </p>
        <p className={styles.detailReport__text}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
