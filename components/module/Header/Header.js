...
const Header = () => {
  ...
  return (
    <div className="container">
      ...
      >
        <Link href="/" className={styles.header__right}>
          <Image
            width={132}
            height={52}
        ...
        <button
          className={`${styles.hamburger} ${
            isMobileMenuOpen ? styles.hamburger_open : ""
          }`}
        ...
        <nav
          className={`${styles.header__menu} ${
            isMobileMenuOpen ? styles.header__menu_open : ""
          }`}
        >
          <button
          ...
          <div className={styles.drawerActions}>
            {!user ? (
              ...
              <Link
                ...
                href={user.role === "admin" ? "/admin-panel" : "/user-panel"}
                onClick={() => setIsMobileMenuOpen(false)}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="btn-drawerMenu">
              ...
              >
                ...
                <span className={styles.btnText}>ثبت آگهی رایگان</span>
              </Link>
            </div>
          </div>
        </nav>
        ...
        <div className={styles.header__left}>
          {!user ? (
            ...
            >
              ...
              <span className={styles.btnText}>حساب من</span>
            </Link>
          )}
          <Link
            className="btn btn-primary btn-sm"
