...
const fetcher = () =>
  fetch("https://rentify-api.runflare.run/api/comments/admin", {
    method: "GET",
...
const Comments = () => {
  ...
  const approveCommentHandler = (id) => {
    fetch(`https://rentify-api.runflare.run/api/comments/${id}/approve`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${getCookie("token")}`,
  ...
  const rejectCommentHandler = (id) => {
    fetch(`https://rentify-api.runflare.run/api/comments/${id}/reject`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${getCookie("token")}`,
